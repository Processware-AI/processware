...
related_tmp:
  - "[[TMP-CMMI-002-01-09_프로젝트_정의_프로세스_PDP_v1.0]]"
related_ex:
  - "[[EX-CMMI-002-01-09_프로젝트_정의_프로세스_PDP_작성예시_v1.0]]"
...
# OSSP 기반 PDP 정의 (WI-CMMI-002-01-09)
...
## 4. 입력 / 산출물
- Input: OSSP, 테일러링 요청서
- Output: [[TMP-CMMI-002-01-09_프로젝트_정의_프로세스_PDP_v1.0]] 승인본
