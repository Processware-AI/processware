...
parent_pro: "[[PRO-SPICE-01-04_머신러닝공학프로세스]]"
related_tmp: []
related_rec: []
...
# ML 모델 개발 통합 업무지침 (WI-SPICE-01-04-01)

> 상위 절차: [[PRO-SPICE-01-04_머신러닝공학프로세스]]
...
## 3. 범위
SAD 의 ML 분배분 인계 + [[PRO-SPICE-01-10_ML데이터관리]] 의 데이터 베이스라인 준비 완료 후부터 모델 v1.0 인계까지 적용한다.
...
## 6. 인터페이스 부서
- **Data Engineering ([[PRO-SPICE-01-10]])**: 데이터셋 인계
- **HW Lead**: 추론 환경 합의
