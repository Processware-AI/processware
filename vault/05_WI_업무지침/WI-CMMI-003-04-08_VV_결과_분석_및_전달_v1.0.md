...
related_tmp: ["[[TMP-CMMI-003-04-08_VV_결과_분석서_v1.0]]"]
related_ex: ["[[EX-CMMI-003-04-08_VV_결과_분석서_작성예시_v1.0]]"]
...
# VV 결과 분석 및 전달 (WI-CMMI-003-04-08)
...
## 4. 입력 / 산출물
- Input: VV 데이터
- Output: [[TMP-CMMI-003-04-08_VV_결과_분석서_v1.0]]
...
## 8. 연계 템플릿
- [[TMP-CMMI-003-04-08_VV_결과_분석서_v1.0]]
- [[EX-CMMI-003-04-08_VV_결과_분석서_작성예시_v1.0]]
