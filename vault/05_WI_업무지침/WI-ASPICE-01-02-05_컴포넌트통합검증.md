...
related_tmp:
  - "[[TMP-ASPICE-01-02-05-01_SW통합시험계획서및결과보고서]]"
related_rec: []
standards: ["Automotive SPICE 4.0"]
aspice_processes: ["SWE.5"]
entry_gate: "WI-ASPICE-01-02-04.status == done"
scope_type: "project"
status: draft
created: "2026-05-06"
updated: "2026-05-06"
...
# SW 컴포넌트/통합 검증 업무지침 (WI-ASPICE-01-02-05)

> 상위 절차: [[PRO-ASPICE-01-02_소프트웨어공학프로세스]] §5 단계 10
...
## 3. 범위
WI-ASPICE-01-02-04 의 유닛 검증 통과 후부터 통합 빌드 + 시험 결과 보고서 등록까지 적용한다.
...
3. **단계적 통합·시험 실행** (SWE.5.BP3/4)
   - CI 파이프라인 자동 실행.
   - Fail 결함은 [[WI-ASPICE-01-08-01_문제등록및분류]] 등록.
...
- **CM (SUP.8)**: 통합 빌드 형상관리
- **QA (SUP.1)**: 검토 게이트
- **System Engineering ([[PRO-ASPICE-01-01]])**: SYS.4 통합 인계
...
## 8. 연계 템플릿 / 기록
- 템플릿: [[TMP-ASPICE-01-02-05-01_SW통합시험계획서및결과보고서]]
- 작성예시: [[EX-ASPICE-01-02-05-01_SW통합시험계획서및결과보고서_작성예시]]
