...
related_tmp:
  - "[[TMP-ASPICE-01-02-01-01_SW요구사항명세서]]"
related_rec: []
...
# SW 요구사항 분석 업무지침 (WI-ASPICE-01-02-01)

> 상위 절차: [[PRO-ASPICE-01-02_소프트웨어공학프로세스]] §5 단계 1~3
...
PRO-ASPICE-01-01 에서 SAD/ICD v1.0 베이스라인 + SW 분배 매트릭스 인계 시점부터 SwRS v1.0 베이스라인 등록 시점까지 적용한다.
...
4. **자원 분석** (SWE.1.BP4)
   ...
   - 초과 시 [[PRO-ASPICE-01-08_문제및변경관리프로세스]] 변경 절차 회귀.
...
- **System Engineering ([[PRO-ASPICE-01-01_시스템공학프로세스]])**: SyRS 변경 협의
...
- 템플릿: [[TMP-ASPICE-01-02-01-01_SW요구사항명세서]]
- 작성예시: [[EX-ASPICE-01-02-01-01_SW요구사항명세서_작성예시]]
