...
related_tmp:
  - "[[TMP-SPICE-01-02-04-01_유닛시험계획서및결과보고서]]"
related_rec: []
standards: ["Automotive SPICE 4.0", "ISO 26262"]
aspice_processes: ["SWE.4"]
entry_gate: "WI-SPICE-01-02-03.status == done"
scope_type: "project"
status: draft
created: "2026-05-06"
updated: "2026-05-06"
...
# SW 유닛 검증 업무지침 (WI-SPICE-01-02-04)

> 상위 절차: [[PRO-SPICE-01-02_소프트웨어공학프로세스]] §5 단계 9
...
WI-SPICE-01-02-03 의 유닛 코드 커밋 후부터 모든 유닛의 시험 + 커버리지 목표 달성 + 결과 보고서 등록까지 적용한다.
...
1. **유닛 시험 케이스 설계** (SWE.4.BP1)
   ...
   - 결과: TMP-SPICE-01-02-04-01 §2 "시험 케이스".
...
## 8. 연계 템플릿 / 기록
- 템플릿: [[TMP-SPICE-01-02-04-01_유닛시험계획서및결과보고서]]
- 작성예시: [[EX-SPICE-01-02-04-01_유닛시험계획서및결과보고서_작성예시]]
