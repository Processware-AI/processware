...
parent_pro: "[[PRO-SPICE-01-03_하드웨어공학프로세스]]"
related_tmp: []
related_rec: []
...
# HW 요구사항 분석 및 설계 통합 업무지침 (WI-SPICE-01-03-01)

> 상위 절차: [[PRO-SPICE-01-03_하드웨어공학프로세스]] §5
...
- **Procurement ([[PRO-SPICE-01-06]])**: 부품 가용성·Lifetime
