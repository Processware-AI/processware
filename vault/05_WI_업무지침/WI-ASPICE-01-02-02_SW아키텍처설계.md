...
related_tmp:
  - "[[TMP-ASPICE-01-02-02-01_SW아키텍처기술서]]"
related_rec: []
standards: ["Automotive SPICE 4.0", "AUTOSAR", "ISO 26262"]
aspice_processes: ["SWE.2"]
entry_gate: "WI-ASPICE-01-02-01.status == done"
scope_type: "project"
status: draft
created: "2026-05-06"
updated: "2026-05-06"
...
# SW 아키텍처 설계 업무지침 (WI-ASPICE-01-02-02)

> 상위 절차: [[PRO-ASPICE-01-02_소프트웨어공학프로세스]] §5 단계 4~5
...
WI-ASPICE-01-02-01 의 SwRS v1.0 베이스라인 등록 후부터 SW Architecture Description (SwAD) v1.0 베이스라인 등록까지 적용한다.
...
3. **자원·타이밍 분석** (SWE.2.BP3)
   ...
   - 결과: TMP-ASPICE-01-02-02-01 §3 "자원/타이밍 분석".
...
## 8. 연계 템플릿 / 기록
- 템플릿: [[TMP-ASPICE-01-02-02-01_SW아키텍처기술서]]
- 작성예시: [[EX-ASPICE-01-02-02-01_SW아키텍처기술서_작성예시]]
