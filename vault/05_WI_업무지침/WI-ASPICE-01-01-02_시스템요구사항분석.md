...
related_tmp:
  - "[[TMP-ASPICE-01-01-02-01_시스템요구사항명세서]]"
related_rec: []
...
# 시스템 요구사항 분석 업무지침 (WI-ASPICE-01-01-02)

> 상위 절차: [[PRO-ASPICE-01-01_시스템공학프로세스]] §5 단계 4~7
...
WI-ASPICE-01-01-01 에서 베이스라인된 StRS 가 입력으로 도착한 시점부터 SyRS v1.0 베이스라인 등록 시점까지 적용한다.
...
1. **시스템 요구사항 정제** (SYS.2.BP1)
   ...
   - 결과: TMP-ASPICE-01-01-02-01 §2 작성.
...
2. **ASIL/CAL/속성 부여** (SYS.2.BP2)
   ...
   - 결과: TMP-ASPICE-01-01-02-01 §3 ASIL/CAL 분배표.
...
3. **영향·일관성 분석** (SYS.2.BP3)
   ...
   - 결과: 분석 보고서 작성, 미해결 이슈는 [[PRO-ASPICE-01-08_문제및변경관리프로세스]] SUP.9 로 등록.
...
5. **StRS↔SyRS 추적성 확립** (SYS.2.BP5)
   ...
   - 결과: 추적성 매트릭스 (TMP-ASPICE-01-01-02-01 §5).
...
- 템플릿: [[TMP-ASPICE-01-01-02-01_시스템요구사항명세서]]
- 작성예시: [[EX-ASPICE-01-01-02-01_시스템요구사항명세서_작성예시]]
