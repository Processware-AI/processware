...
# SW 상세설계 및 유닛 구현 업무지침 (WI-ASPICE-01-02-03)

> 상위 절차: [[PRO-ASPICE-01-02_소프트웨어공학프로세스]] §5 단계 6~8
...
WI-ASPICE-01-02-02 의 SwAD v1.0 베이스라인 등록 후부터 모든 유닛 코드의 정적분석·리뷰 통과 + 형상관리 시스템 커밋까지 적용한다.
...
1. **모듈 상세설계** (SWE.3.BP1)
   ...
   - 결과: TMP-ASPICE-01-02-03-01 §1 "상세설계".
...
5. **동료 코드리뷰** (SWE.3.BP5)
   ...
   - 결과: TMP-ASPICE-01-02-03-01 §3 "리뷰 기록".
...
## 8. 연계 템플릿 / 기록
- 템플릿: [[TMP-ASPICE-01-02-03-01_SW상세설계서및구현이력]]
- 작성예시: [[EX-ASPICE-01-02-03-01_SW상세설계서및구현이력_작성예시]]
