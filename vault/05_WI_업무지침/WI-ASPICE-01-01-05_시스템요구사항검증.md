...
related_tmp:
  - "[[TMP-ASPICE-01-01-05-01_시스템검증보고서]]"
related_rec: []
standards: ["Automotive SPICE 4.0"]
aspice_processes: ["SYS.5"]
entry_gate: "WI-ASPICE-01-01-04.status == done"
scope_type: "project"
status: draft
created: "2026-05-06"
updated: "2026-05-06"
...
# 시스템 요구사항 검증 업무지침 (WI-ASPICE-01-01-05)

> 상위 절차: [[PRO-ASPICE-01-01_시스템공학프로세스]] §5 단계 16~18
...
WI-ASPICE-01-01-04 의 통합 시험 종료(통합 보고서 승인) 후부터 SYS.5 검증 보고서 v1.0 등록 + 검증 결과의 [[PRO-ASPICE-01-05]] (VAL/SPL) 인계 시점까지 적용한다.
...
6. **검증 결과 보고** (SYS.5.BP5)
   ...
   - 결함 폐쇄율·잔여 리스크가 출시 게이트 기준 미달 시 [[PRO-ASPICE-01-05]] 인계 보류.
...
- **Validation/Release ([[PRO-ASPICE-01-05]])**: 검증 결과 인계 수령
...
- 잔여 결함이 있으나 출시 일정이 임박한 경우:
  ...
  - 모든 Deviation 은 [[PRO-ASPICE-01-08]] CCB 결재 + 공식 문서화.
...
- 템플릿: [[TMP-ASPICE-01-01-05-01_시스템검증보고서]]
- 작성예시: [[EX-ASPICE-01-01-05-01_시스템검증보고서_작성예시]]
