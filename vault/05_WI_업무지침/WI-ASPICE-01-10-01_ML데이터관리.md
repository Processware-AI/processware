...
parent_pro: "[[PRO-ASPICE-01-10_데이터및머신러닝지원프로세스]]"
related_tmp: []
related_rec: []
...
# ML 데이터 관리 업무지침 (WI-ASPICE-01-10-01)

> 상위 절차: [[PRO-ASPICE-01-10_데이터및머신러닝지원프로세스]]
...
## 6. 인터페이스 부서
- **ML Engineering ([[PRO-ASPICE-01-04]])**: 데이터 인계
