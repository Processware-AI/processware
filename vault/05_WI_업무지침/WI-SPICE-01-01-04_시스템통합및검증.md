...
related_tmp:
  - "[[TMP-SPICE-01-01-04-01_통합시험계획서및결과보고서]]"
related_rec: []
standards: ["Automotive SPICE 4.0"]
aspice_processes: ["SYS.4"]
entry_gate: "WI-SPICE-01-01-03.status == done"
scope_type: "project"
status: draft
created: "2026-05-06"
updated: "2026-05-06"
...
# 시스템 통합 및 통합 시험 업무지침 (WI-SPICE-01-01-04)

> 상위 절차: [[PRO-SPICE-01-01_시스템공학프로세스]] §5 단계 13~15
> ASPICE 매핑: SYS.4 (System Integration and Integration Test) — BP1~BP5

## 1. 업무 목적

SW/HW/ML 도메인에서 전달된 컴포넌트를 시스템 아키텍처에 따라 단계적으로 통합하고, 통합 단계마다 정의된 시험을 실행하여 결과를 기록·보고하며, 결함은 [[PRO-SPICE-01-08_문제및변경관리프로세스]] 로 이관한다.
...
WI-SPICE-01-01-03 의 SAD/ICD 베이스라인 등록 후, SW/HW/ML 도메인에서 첫 통합 가능 컴포넌트를 인계받은 시점부터 통합 시험 결과 보고서 v1.0 등록까지 적용한다.

## 4. 입력 자료 / 산출물

- **Input**
  - SAD/ICD v1.0
  - SW 컴포넌트 빌드 산출물 ([[PRO-SPICE-01-02_소프트웨어공학프로세스]])
  - HW 시제품 ([[PRO-SPICE-01-03_하드웨어공학프로세스]])
  - ML 모델 산출물 ([[PRO-SPICE-01-04_머신러닝공학프로세스]])
  - 분배 매트릭스
...
4. **단계적 통합·시험 실행** (SYS.4.BP3/4)
   ...
   - Fail 발견 시 즉시 [[WI-SPICE-01-08-01_문제등록및분류]] 로 결함 등록.
   - 결과: TMP-SPICE-01-01-04-01 §4 "시험 결과 로그".
...
- 템플릿: [[TMP-SPICE-01-01-04-01_통합시험계획서및결과보고서]]
- 작성예시: [[EX-SPICE-01-01-04-01_통합시험계획서및결과보고서_작성예시]]
