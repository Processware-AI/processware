...
related_tmp:
  - "[[TMP-ASPICE-01-02-06-01_SW검증보고서]]"
related_rec: []
standards: ["Automotive SPICE 4.0"]
aspice_processes: ["SWE.6"]
entry_gate: "WI-ASPICE-01-02-05.status == done"
scope_type: "project"
status: draft
created: "2026-05-06"
updated: "2026-05-06"
...
# SW 검증 업무지침 (WI-ASPICE-01-02-06)

> 상위 절차: [[PRO-ASPICE-01-02_소프트웨어공학프로세스]] §5 단계 11~12
...
## 3. 범위
WI-ASPICE-01-02-05 의 통합 빌드 + 보고서 등록 후부터 SW 검증 보고서 v1.0 등록 + SYS.4 (시스템 통합) 인계 시점까지 적용한다.
...
## 6. 인터페이스 부서
- **QA (SUP.1)**: 독립 승인
- **System Engineering ([[PRO-ASPICE-01-01]])**: SYS.4 시스템 통합 인계
- **CM (SUP.8)**: 검증 빌드 형상관리
...
## 8. 연계 템플릿 / 기록
- 템플릿: [[TMP-ASPICE-01-02-06-01_SW검증보고서]]
- 작성예시: [[EX-ASPICE-01-02-06-01_SW검증보고서_작성예시]]
