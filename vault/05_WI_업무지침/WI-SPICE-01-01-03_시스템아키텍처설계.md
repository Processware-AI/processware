...
# 시스템 아키텍처 설계 업무지침 (WI-SPICE-01-01-03)

> 상위 절차: [[PRO-SPICE-01-01_시스템공학프로세스]] §5 단계 8~12
...
WI-SPICE-01-01-02 의 SyRS v1.0 베이스라인 등록 후부터 System Architecture Description (SAD) v1.0 베이스라인 등록까지 적용한다.
...
1. **아키텍처 정의** (SYS.3.BP1)
   ...
   - 결과: TMP-SPICE-01-01-03-01 §2 "요소 분해 구조" 작성.
...
4. **SW/HW/ML 요소 분배** (SYS.3.BP4)
   ...
   - 결과: TMP-SPICE-01-01-03-01 §4 "분배 매트릭스".
...
- 템플릿: [[TMP-SPICE-01-01-03-01_시스템아키텍처기술서]]
- 작성예시: [[EX-SPICE-01-01-03-01_시스템아키텍처기술서_작성예시]]
