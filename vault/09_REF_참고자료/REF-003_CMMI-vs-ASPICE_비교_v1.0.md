...
version: "1.0"
source: "ISACA CMMI v2.0 + VDA Automotive SPICE v3.1/4.0"
...
> 출처: ISACA CMMI v2.0 + VDA Automotive SPICE v3.1/4.0 (둘 다 paraphrase only)
> 최종 확인일: 2026-04-29
...
| 항목 | CMMI-DEV v2.0 | ASPICE v3.1/4.0 |
|---|---|---|
