...
child_wi:
  - "[[WI-ASPICE-01-03-01_HW요구사항분석]]"
  - "[[WI-ASPICE-01-03-02_회로및PCB설계]]"
  - "[[WI-ASPICE-01-03-03_BOM관리]]"
  - "[[WI-ASPICE-01-03-04_HW설계검증]]"
  - "[[WI-ASPICE-01-03-05_HW요구사항검증]]"
...
wi_sequence:
  - wi_id: "WI-ASPICE-01-03-01"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-ASPICE-01-03-02"
    mandatory: true
    entry_condition: "WI-ASPICE-01-03-01.status == done"
  - wi_id: "WI-ASPICE-01-03-03"
    mandatory: true
    entry_condition: "WI-ASPICE-01-03-02.status == done"
  - wi_id: "WI-ASPICE-01-03-04"
    mandatory: true
    entry_condition: "WI-ASPICE-01-03-03.status == done"
  - wi_id: "WI-ASPICE-01-03-05"
    mandatory: true
    entry_condition: "WI-ASPICE-01-03-04.status == done"
status: draft
created: "2026-05-06"
updated: "2026-05-06"
...
VWAY Motors 가 자체 설계하는 ECU PCB, 도메인 컨트롤러 보드, 센서/액추에이터 인터페이스 보드에 적용한다. 외주 HW(공급사 OEM 보드 통합) 는 [[PRO-ASPICE-01-06_구매및공급망프로세스]] 적용 후 본 절차의 HWE.4 (요구사항 검증) 만 적용한다.
...
| ASPICE 조항 | Req-ID | 반영 |
|---|---|---|
| HWE.1 Purpose / BP1 / BP5 | ASPICE-HWE1-R-001/002/003 | §5 단계 1~3 |
| HWE.2 Purpose / BP2 | ASPICE-HWE2-R-001/002 | §5 단계 4~6 |
| HWE.3 Purpose / BP4 | ASPICE-HWE3-R-001/002 | §5 단계 7 |
| HWE.4 Purpose / BP4 | ASPICE-HWE4-R-001/002 | §5 단계 8~9 |
