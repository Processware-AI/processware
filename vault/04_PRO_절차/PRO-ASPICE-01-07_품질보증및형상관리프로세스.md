...
child_wi:
  - "[[WI-ASPICE-01-07-01_QA계획수립]]"
  - "[[WI-ASPICE-01-07-02_QA감사실시]]"
  - "[[WI-ASPICE-01-07-03_시정조치및에스컬레이션]]"
  - "[[WI-ASPICE-01-07-04_형상항목식별]]"
  - "[[WI-ASPICE-01-07-05_베이스라인및변경통제]]"
  - "[[WI-ASPICE-01-07-06_형상감사]]"
...
precedes: []
wi_sequence:
  - wi_id: "WI-ASPICE-01-07-01"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-ASPICE-01-07-02"
    mandatory: true
    entry_condition: "WI-ASPICE-01-07-01.status == done"
  - wi_id: "WI-ASPICE-01-07-03"
    mandatory: false
    entry_condition: "audit_finding_detected == true"
  - wi_id: "WI-ASPICE-01-07-04"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-ASPICE-01-07-05"
    mandatory: true
    entry_condition: "WI-ASPICE-01-07-04.status == done"
  - wi_id: "WI-ASPICE-01-07-06"
    mandatory: true
    entry_condition: "WI-ASPICE-01-07-05.status == done"
status: draft
created: "2026-05-06"
updated: "2026-05-06"
...
# 품질보증 및 형상관리 프로세스 (PRO-ASPICE-01-07)
...
| ASPICE 조항 | Req-ID | 반영 |
|---|---|---|
| SUP.1 Purpose / BP3 / BP4 | ASPICE-SUP1-R-001/002/003 | §5 단계 1~5 |
| SUP.8 Purpose / BP2 / BP4 | ASPICE-SUP8-R-001/002/003 | §5 단계 6~9 |
