...
child_wi:
  - "[[WI-SPICE-01-02-01_SW요구사항분석]]"
  - "[[WI-SPICE-01-02-02_SW아키텍처설계]]"
  - "[[WI-SPICE-01-02-03_상세설계및유닛구현]]"
  - "[[WI-SPICE-01-02-04_유닛검증]]"
  - "[[WI-SPICE-01-02-05_컴포넌트통합검증]]"
  - "[[WI-SPICE-01-02-06_SW검증]]"
...
wi_sequence:
  - wi_id: "WI-SPICE-01-02-01"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-SPICE-01-02-02"
    mandatory: true
    entry_condition: "WI-SPICE-01-02-01.status == done"
  - wi_id: "WI-SPICE-01-02-03"
    mandatory: true
    entry_condition: "WI-SPICE-01-02-02.status == done"
  - wi_id: "WI-SPICE-01-02-04"
    mandatory: true
    entry_condition: "WI-SPICE-01-02-03.status == done"
  - wi_id: "WI-SPICE-01-02-05"
    mandatory: true
    entry_condition: "WI-SPICE-01-02-04.status == done"
  - wi_id: "WI-SPICE-01-02-06"
    mandatory: true
    entry_condition: "WI-SPICE-01-02-05.status == done"
status: draft
created: "2026-05-06"
updated: "2026-05-06"
...
VWAY Motors 가 자체 개발하는 ECU 임베디드 SW, AUTOSAR 컴포넌트, ADAS 미들웨어에 적용한다. 외주 SW(공급사 OEM SW) 는 [[PRO-SPICE-01-06_구매및공급망프로세스]] 적용 후 인수 검증 단계에서 본 절차의 SWE.5/SWE.6 만 적용한다.
...
| ASPICE 조항 | Req-ID | 반영 |
|---|---|---|
| SWE.1 Purpose / BP1 / BP5 | SPICE-SWE1-R-001/002/003 | §5 단계 1~3 |
| SWE.2 Purpose / BP3 | SPICE-SWE2-R-001/002 | §5 단계 4~5 |
| SWE.3 Purpose / BP3 | SPICE-SWE3-R-001/002 | §5 단계 6~8, §7 MISRA |
| SWE.4 Purpose / BP3 | SPICE-SWE4-R-001/002 | §5 단계 9, §7 커버리지 |
| SWE.5 Purpose / BP4 | SPICE-SWE5-R-001/002 | §5 단계 10 |
| SWE.6 Purpose / BP4 | SPICE-SWE6-R-001/002 | §5 단계 11~12 |
