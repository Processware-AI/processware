...
child_wi:
  - "[[WI-ASPICE-01-08-01_문제등록및분류]]"
  - "[[WI-ASPICE-01-08-02_근본원인분석]]"
  - "[[WI-ASPICE-01-08-03_변경요청접수]]"
  - "[[WI-ASPICE-01-08-04_영향평가]]"
  - "[[WI-ASPICE-01-08-05_CCB운영]]"
  - "[[WI-ASPICE-01-08-06_변경구현및검증]]"
...
precedes: []
wi_sequence:
  - wi_id: "WI-ASPICE-01-08-01"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-ASPICE-01-08-02"
    mandatory: true
    entry_condition: "WI-ASPICE-01-08-01.status == done"
  - wi_id: "WI-ASPICE-01-08-03"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-ASPICE-01-08-04"
    mandatory: true
    entry_condition: "WI-ASPICE-01-08-03.status == done"
  - wi_id: "WI-ASPICE-01-08-05"
    mandatory: true
    entry_condition: "WI-ASPICE-01-08-04.status == done"
  - wi_id: "WI-ASPICE-01-08-06"
    mandatory: true
    entry_condition: "WI-ASPICE-01-08-05.status == approved"
status: draft
created: "2026-05-06"
updated: "2026-05-06"
...
# 문제 및 변경 관리 프로세스 (PRO-ASPICE-01-08)
...
| ASPICE 조항 | Req-ID | 반영 |
|---|---|---|
| SUP.9 Purpose / BP3 | ASPICE-SUP9-R-001/002 | §5 단계 1~3 |
| SUP.10 Purpose / BP3 | ASPICE-SUP10-R-001/002 | §5 단계 4~7 |
