...
child_wi:
  - "[[WI-SPICE-01-09-01_프로젝트계획수립]]"
  - "[[WI-SPICE-01-09-02_실현가능성평가]]"
  - "[[WI-SPICE-01-09-03_WBS및진척통제]]"
  - "[[WI-SPICE-01-09-04_역량매트릭스관리]]"
  - "[[WI-SPICE-01-09-05_리스크식별및평가]]"
  - "[[WI-SPICE-01-09-06_리스크완화추적]]"
  - "[[WI-SPICE-01-09-07_측정지표수집]]"
  - "[[WI-SPICE-01-09-08_측정결과보고]]"
...
follows: []
precedes: ["PRO-SPICE-01-01", "PRO-SPICE-01-06"]
wi_sequence:
  - wi_id: "WI-SPICE-01-09-01"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-SPICE-01-09-02"
    mandatory: true
    entry_condition: "WI-SPICE-01-09-01.status == done"
  - wi_id: "WI-SPICE-01-09-03"
    mandatory: true
    entry_condition: "WI-SPICE-01-09-02.status == done"
  - wi_id: "WI-SPICE-01-09-04"
    mandatory: true
    entry_condition: "WI-SPICE-01-09-01.status == done"
  - wi_id: "WI-SPICE-01-09-05"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-SPICE-01-09-06"
    mandatory: true
    entry_condition: "WI-SPICE-01-09-05.status == done"
  - wi_id: "WI-SPICE-01-09-07"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-SPICE-01-09-08"
    mandatory: true
    entry_condition: "WI-SPICE-01-09-07.status == done"
status: draft
created: "2026-05-06"
updated: "2026-05-06"
...
| ASPICE 조항 | Req-ID | 반영 |
|---|---|---|
| MAN.3 Purpose / BP3 / BP4 / BP6 | SPICE-MAN3-R-001/002/003/004 | §5 단계 1~7 |
| MAN.5 Purpose / BP3 | SPICE-MAN5-R-001/002 | §5 단계 8~10 |
| MAN.6 Purpose / BP3 | SPICE-MAN6-R-001/002 | §5 단계 11~12 |
