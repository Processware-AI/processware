...
child_wi:
  - "[[WI-SPICE-01-01-01_이해관계자요구사항도출]]"
  - "[[WI-SPICE-01-01-02_시스템요구사항분석]]"
  - "[[WI-SPICE-01-01-03_시스템아키텍처설계]]"
  - "[[WI-SPICE-01-01-04_시스템통합및검증]]"
  - "[[WI-SPICE-01-01-05_시스템요구사항검증]]"
  - "[[WI-SPICE-01-01-06_추적성매트릭스관리]]"
...
follows: []
precedes: ["PRO-SPICE-01-02", "PRO-SPICE-01-03", "PRO-SPICE-01-04"]
wi_sequence:
  - wi_id: "WI-SPICE-01-01-01"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-SPICE-01-01-02"
    mandatory: true
    entry_condition: "WI-SPICE-01-01-01.status == done"
  - wi_id: "WI-SPICE-01-01-03"
    mandatory: true
    entry_condition: "WI-SPICE-01-01-02.status == done"
  - wi_id: "WI-SPICE-01-01-04"
    mandatory: true
    entry_condition: "WI-SPICE-01-01-03.status == done"
  - wi_id: "WI-SPICE-01-01-05"
    mandatory: true
    entry_condition: "WI-SPICE-01-01-04.status == done"
  - wi_id: "WI-SPICE-01-01-06"
    mandatory: true
    entry_condition: "WI-SPICE-01-01-01.status == done"
status: draft
created: "2026-05-06"
...
VWAY Motors 가 OEM 으로 인도하는 차량 ECU·도메인 컨트롤러·ADAS 시스템의 모든 신규 개발·중대 변경에 적용한다. 단순 BOM 변경, 라벨 변경 등 시스템 아키텍처에 영향이 없는 경미 변경은 [[PRO-SPICE-01-08_문제및변경관리프로세스]] (SUP.10) 만 적용한다.
...
- [[WI-SPICE-01-01-01_이해관계자요구사항도출]] — SYS.1 elicitation·합의 절차
- [[WI-SPICE-01-01-02_시스템요구사항분석]] — SYS.2 SyRS 작성·ASIL 분류
- [[WI-SPICE-01-01-03_시스템아키텍처설계]] — SYS.3 아키텍처·ICD·분배
- [[WI-SPICE-01-01-04_시스템통합및검증]] — SYS.4 통합 시험 운영
- [[WI-SPICE-01-01-05_시스템요구사항검증]] — SYS.5 HIL/Bench/차량 검증
- [[WI-SPICE-01-01-06_추적성매트릭스관리]] — 추적성 매트릭스 작성·유지
...
| ASPICE 조항 | Req-ID | 반영 |
|---|---|---|
| SYS.1 Purpose | SPICE-SYS1-R-001 | §4 절차흐름 A1·A2 / §5 단계 1~3 |
| SYS.1.BP1 (이해관계자 식별) | SPICE-SYS1-R-002 | §5 단계 1 |
| SYS.1.BP3 (변경 합의) | SPICE-SYS1-R-003 | §5 단계 3, §7 변경 영향 KPI |
| SYS.2 Purpose | SPICE-SYS2-R-001 | §4 B1~B4 / §5 단계 4~7 |
| SYS.2.BP1 (기능/비기능 명세) | SPICE-SYS2-R-002 | §5 단계 4 |
| SYS.2.BP5 (양방향 추적성) | SPICE-SYS2-R-003 | §5 단계 7, §7 추적성 KPI |
| SYS.3 Purpose | SPICE-SYS3-R-001 | §4 C1~C5 / §5 단계 8~12 |
| SYS.3.BP1 (요소·인터페이스 식별) | SPICE-SYS3-R-002 | §5 단계 8~9 |
| SYS.3.BP5 (양방향 추적성) | SPICE-SYS3-R-003 | §5 단계 12 |
| SYS.4 Purpose | SPICE-SYS4-R-001 | §4 D1~D4 / §5 단계 13~15 |
| SYS.4.BP3 (검증 측정치 실행) | SPICE-SYS4-R-002 | §5 단계 14~15 |
| SYS.5 Purpose | SPICE-SYS5-R-001 | §4 E1~E3 / §5 단계 16~18 |
| SYS.5.BP3 (검증 결과·이슈 이관) | SPICE-SYS5-R-002 | §5 단계 18 |
