...
child_wi:
  - "[[WI-ASPICE-01-10-01_데이터수집및라벨링]]"
  - "[[WI-ASPICE-01-10-02_라이선스및개인정보검증]]"
  - "[[WI-ASPICE-01-10-03_데이터품질평가]]"
  - "[[WI-ASPICE-01-10-04_데이터버전및베이스라인]]"
...
follows: []
precedes: ["PRO-ASPICE-01-04"]
wi_sequence:
  - wi_id: "WI-ASPICE-01-10-01"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-ASPICE-01-10-02"
    mandatory: true
    entry_condition: "WI-ASPICE-01-10-01.status == done"
  - wi_id: "WI-ASPICE-01-10-03"
    mandatory: true
    entry_condition: "WI-ASPICE-01-10-02.status == done"
  - wi_id: "WI-ASPICE-01-10-04"
    mandatory: true
    entry_condition: "WI-ASPICE-01-10-03.status == done"
status: draft
created: "2026-05-06"
updated: "2026-05-06"
...
# ML 데이터 관리 프로세스 (PRO-ASPICE-01-10)
...
ML 모델 학습·검증·테스트에 사용되는 **데이터셋의 식별·수집·품질평가·라이선스 적합성·개인정보 처리·버전 관리·재현성** 을 통제된 흐름으로 운영한다 (SUP.11). [[PRO-ASPICE-01-04_머신러닝공학프로세스]] 의 학습·테스트 단계의 입력 보장을 책임진다.
...
| ASPICE 조항 | Req-ID | 반영 |
|---|---|---|
| SUP.11 Purpose | ASPICE-SUP11-R-001 | §1, §4 전체 |
| SUP.11.BP2 (라이선스) | ASPICE-SUP11-R-002 | §5 단계 2 |
| SUP.11.BP4 (버전·재현성) | ASPICE-SUP11-R-003 | §5 단계 4~5 |
