...
child_wi:
  - "[[WI-SPICE-01-06-01_공동활동운영]]"
  - "[[WI-SPICE-01-06-02_공급사정보교환]]"
  - "[[WI-SPICE-01-06-03_공급사성과모니터링]]"
  - "[[WI-SPICE-01-06-04_합의변경및시정조치]]"
standards: ["Automotive SPICE 4.0"]
tier: "C"
pro_type: "core"
scope_type: "org"
source_scenarios: ["SCN-018"]
follows: ["PRO-SPICE-01-09"]
precedes: []
wi_sequence:
  - wi_id: "WI-SPICE-01-06-01"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-SPICE-01-06-02"
    mandatory: true
    entry_condition: "WI-SPICE-01-06-01.status == done"
  - wi_id: "WI-SPICE-01-06-03"
    mandatory: true
    entry_condition: "WI-SPICE-01-06-02.status == done"
  - wi_id: "WI-SPICE-01-06-04"
    mandatory: false
...
VWAY Motors 가 Tier 2/3 SW/HW/ML 공급사로부터 수령하는 모든 작업 산출물(소스코드·바이너리·HW 보드·학습 데이터·문서) 에 적용한다. 단순 부품 구매(상용 OTS 부품) 는 [[PRO-SPICE-01-09_프로젝트관리프로세스]] 의 자원 관리에서 다룬다.
...
| ASPICE 조항 | Req-ID | 반영 |
|---|---|---|
| ACQ.4 Purpose | SPICE-ACQ4-R-001 | §1 목적, §4 전체 |
| ACQ.4.BP1 (공동 활동) | SPICE-ACQ4-R-002 | §5 단계 2 |
| ACQ.4.BP3 (산출물 리뷰) | SPICE-ACQ4-R-003 | §5 단계 4 |
| ACQ.4.BP5 (시정조치) | SPICE-ACQ4-R-004 | §5 단계 5 |
