...
child_wi:
  - "[[WI-ASPICE-01-11-01_프로세스평가]]"
  - "[[WI-ASPICE-01-11-02_개선기회식별및실행]]"
  - "[[WI-ASPICE-01-11-03_재사용전략수립]]"
  - "[[WI-ASPICE-01-11-04_재사용자산등록및인증]]"
  - "[[WI-ASPICE-01-11-05_재사용자산유지및검색성]]"
...
precedes: []
wi_sequence:
  - wi_id: "WI-ASPICE-01-11-01"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-ASPICE-01-11-02"
    mandatory: true
    entry_condition: "WI-ASPICE-01-11-01.status == done"
  - wi_id: "WI-ASPICE-01-11-03"
    mandatory: true
    entry_condition: null
  - wi_id: "WI-ASPICE-01-11-04"
    mandatory: true
    entry_condition: "WI-ASPICE-01-11-03.status == done"
  - wi_id: "WI-ASPICE-01-11-05"
    mandatory: true
    entry_condition: "WI-ASPICE-01-11-04.status == done"
status: draft
created: "2026-05-06"
updated: "2026-05-06"
retention: "상시"
...
# 프로세스 개선 및 재사용 프로세스 (PRO-ASPICE-01-11)
...
조직 표준 프로세스(SPP) 의 **지속적 개선(PIM.3)** 과 **재사용 가능한 작업 산출물(컴포넌트·라이브러리·문서 템플릿) 의 식별·인증·유지·검색 가능성 보장(REU.2)** 을 운영한다. POL-ASPICE-01 의 §3 원칙 2 (Generic Practice 제도화) 를 실현하는 조직 차원 활동이다.
...
| ASPICE 조항 | Req-ID | 반영 |
|---|---|---|
| PIM.3 Purpose / BP3 | ASPICE-PIM3-R-001/002 | §5 단계 1~5 |
| REU.2 Purpose / BP2 | ASPICE-REU2-R-001/002 | §5 단계 6~9 |
