...
scope_code: SPICE
child_pro:
  - "[[PRO-SPICE-01-01_시스템공학프로세스]]"
  - "[[PRO-SPICE-01-02_소프트웨어공학프로세스]]"
  - "[[PRO-SPICE-01-03_하드웨어공학프로세스]]"
  - "[[PRO-SPICE-01-04_머신러닝공학프로세스]]"
  - "[[PRO-SPICE-01-05_검증및인도프로세스]]"
  - "[[PRO-SPICE-01-06_구매및공급망프로세스]]"
  - "[[PRO-SPICE-01-07_품질보증및형상관리프로세스]]"
  - "[[PRO-SPICE-01-08_문제및변경관리프로세스]]"
  - "[[PRO-SPICE-01-09_프로젝트관리프로세스]]"
  - "[[PRO-SPICE-01-10_ML데이터관리프로세스]]"
  - "[[PRO-SPICE-01-11_프로세스개선및재사용]]"
...
# ASPICE 역량 거버넌스 정책 (POL-SPICE-01)
...
| 표준 조항 | Req-ID | 반영 |
|---|---|---|
| ASPICE 4.0 PA 1.1 (Process Performance) | SPICE-GOV-R-001 | §3 원칙 1, §6 자가평가 |
| ASPICE 4.0 PA 2.1 (Performance Mgmt) | SPICE-GOV-R-001 | §4 역할, §6 시정조치 |
| ASPICE 4.0 PA 2.2 (Work Product Mgmt) | SPICE-GOV-R-001 | §3 원칙 3 (추적성) |
| ASPICE 4.0 PA 3.1 (Process Definition) | SPICE-GOV-R-001 | §4 PQO 책임 |
| ASPICE 4.0 PA 3.2 (Process Deployment) | SPICE-GOV-R-001 | §5 차등 목표, §7 하위 PRO |
| ASPICE SUP.1.BP4 (QA 독립성) | SPICE-SUP1-R-003 | §3 원칙 4, §4 QA Lead |
| ASPICE MAN.3.BP6 (역량 식별) | SPICE-MAN3-R-004 | §4·§5 (역량/Level 차등) |
| ASPICE PIM.3 Purpose | SPICE-PIM3-R-001 | §6 평가 주기, §7 PRO-11 |
...
- type: standard_original
  ...
  paraphrase_only: true
- type: llm_inference
  basis: "32 프로세스를 통합 거버넌스로 묶기 위한 합성 — 적용요건 §1.10 SPICE-GOV-R-001 정의"
  retrieved_at: "2026-05-06"
