...
child_pro:
  - "[[PRO-CMMI-02-01_프로젝트_계획_절차_v1.0]]"
  - "[[PRO-CMMI-02-02_프로젝트_모니터링_및_통제_절차_v1.0]]"
  - "[[PRO-CMMI-02-03_추정_관리_절차_v1.0]]"
  - "[[PRO-CMMI-02-04_성과_및_측정_관리_절차_v1.0]]"
  - "[[PRO-CMMI-02-05_리스크_및_기회_관리_절차_v1.0]]"
...
- 외주·공동개발 프로젝트는 인수자 측 책임 범위에 적용 (공급자 본인 활동은 POL-CMMI-05 참조)
...
## 5. 준수 기준
- 모든 프로젝트는 착수 시 [[PRO-CMMI-02-01_프로젝트_계획_절차_v1.0]] 에 따라 계획서를 작성·승인 받음
- 추정은 [[PRO-CMMI-02-03_추정_관리_절차_v1.0]] 의 모델·과거데이터(PAL) 사용을 원칙으로 함
- 진척·성과·리스크 보고 주기는 프로젝트 등급별로 [[PRO-CMMI-02-02_프로젝트_모니터링_및_통제_절차_v1.0]] 정의 준수
- 측정 데이터는 [[PRO-CMMI-02-04_성과_및_측정_관리_절차_v1.0]] 에 따라 조직 측정 저장소에 등재
- 계획 대비 일정·예산 ±10% 또는 핵심 리스크 발생 시 시정조치 절차 가동

## 6. 관련 하위 절차 (PRO)
- [[PRO-CMMI-02-01_프로젝트_계획_절차_v1.0]] — PLAN PA
- [[PRO-CMMI-02-02_프로젝트_모니터링_및_통제_절차_v1.0]] — MC PA
- [[PRO-CMMI-02-03_추정_관리_절차_v1.0]] — EST PA
- [[PRO-CMMI-02-04_성과_및_측정_관리_절차_v1.0]] — MPM PA
- [[PRO-CMMI-02-05_리스크_및_기회_관리_절차_v1.0]] — RSK PA
