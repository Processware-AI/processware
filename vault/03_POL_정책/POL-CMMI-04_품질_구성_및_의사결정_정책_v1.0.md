...
child_pro:
  - "[[PRO-CMMI-04-01_프로세스_품질보증_절차_v1.0]]"
  - "[[PRO-CMMI-04-02_형상관리_절차_v1.0]]"
  - "[[PRO-CMMI-04-03_근본원인분석_및_해결_절차_v1.0]]"
  - "[[PRO-CMMI-04-04_의사결정_분석_및_해결_절차_v1.0]]"
...
- 부적합 종결까지 [[PRO-CMMI-04-01_프로세스_품질보증_절차_v1.0]] 의 추적 의무
- DAR 적용기준 (예: 비용 임계 초과·기술 리스크 高·인터페이스 영향 多) 충족 결정은 의사결정평가서 작성
- 반복 부적합·중대 결과는 CAR 발의

## 6. 관련 하위 절차 (PRO)
- [[PRO-CMMI-04-01_프로세스_품질보증_절차_v1.0]] — PQA PA
- [[PRO-CMMI-04-02_형상관리_절차_v1.0]] — CM PA
- [[PRO-CMMI-04-03_근본원인분석_및_해결_절차_v1.0]] — CAR PA
- [[PRO-CMMI-04-04_의사결정_분석_및_해결_절차_v1.0]] — DAR PA
