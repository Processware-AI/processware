...
child_pro:
  - "[[PRO-CMMI-101_거버넌스_운영_절차_v1.0]]"
  - "[[PRO-CMMI-102_프로세스_자산_개발_절차_v1.0]]"
  - "[[PRO-CMMI-103_프로세스_관리_및_개선_절차_v1.0]]"
  - "[[PRO-CMMI-104_구현_인프라_운영_절차_v1.0]]"
...
- 프로젝트는 착수 30일 내 OSSP 기반 테일러링된 프로세스를 정의·승인 (PRO-CMMI-201 연계)
- 모든 PA 활동은 II PG2~PG3 의 자원·도구·교육·내재화 점검을 통과해야 함
- 프로세스 자산 등재 전 형상관리(POL-CMMI-004) 통과 필수

## 6. 관련 하위 절차 (PRO)
- [[PRO-CMMI-101_거버넌스_운영_절차_v1.0]] — GOV PA (경영진 방향·자원·검토)
- [[PRO-CMMI-102_프로세스_자산_개발_절차_v1.0]] — PAD PA (OSSP·테일러링·PAL)
- [[PRO-CMMI-103_프로세스_관리_및_개선_절차_v1.0]] — PCM PA (개선기회·전개·평가)
- [[PRO-CMMI-104_구현_인프라_운영_절차_v1.0]] — II PA (자원제공·일관실행·준수검토)
