...
child_pro:
  - "[[PRO-CMMI-301_요구사항_개발_및_관리_절차_v1.0]]"
  - "[[PRO-CMMI-302_기술솔루션_절차_v1.0]]"
  - "[[PRO-CMMI-303_제품통합_절차_v1.0]]"
  - "[[PRO-CMMI-304_검증_및_확인_절차_v1.0]]"
  - "[[PRO-CMMI-305_동료검토_절차_v1.0]]"
...
## 5. 준수 기준
- 요구사항은 [[PRO-CMMI-301_요구사항_개발_및_관리_절차_v1.0]] 에 따라 추적성 매트릭스에 등재
- 주요 설계 결정은 POL-CMMI-004 의 의사결정 분석(DAR) 적용 대상
- 통합·V&V 환경은 형상관리(POL-CMMI-004) 통제 하에 유지
- 동료검토 대상·기준은 [[PRO-CMMI-305_동료검토_절차_v1.0]] 정의 준수, 데이터는 측정저장소(POL-CMMI-001) 등재
- 인터페이스(ICD)·운영개념(OpsCon)·사용자 문서는 산출물 필수

## 6. 관련 하위 절차 (PRO)
- [[PRO-CMMI-301_요구사항_개발_및_관리_절차_v1.0]] — RDM PA
- [[PRO-CMMI-302_기술솔루션_절차_v1.0]] — TS PA
- [[PRO-CMMI-303_제품통합_절차_v1.0]] — PI PA
- [[PRO-CMMI-304_검증_및_확인_절차_v1.0]] — VV PA
- [[PRO-CMMI-305_동료검토_절차_v1.0]] — PR PA
